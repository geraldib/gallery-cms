...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=UserPostLike::class, mappedBy="user", orphanRemoval=true)
     */
    ...
    public function removeUserPostLike(UserPostLike $userPostLike): self
    {
        if ($this->userPostLikes->removeElement($userPostLike)) {
            // set the owning side to null (unless already changed)
            if ($userPostLike->getUser() === $this) {
                $userPostLike->setUser(null);
            }
        }
